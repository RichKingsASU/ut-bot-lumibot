                                    ...
                                    <tr>
                                        <td colSpan={6} className="px-6 py-24 text-center">
                                            <div className="flex flex-col items-center gap-3 text-dim">
                                                ...
                                                <span className="text-xs font-bold uppercase tracking-widest">No Active Signals Detected</span>
                                                <p className="text-[10px] max-w-[200px]">Surveillance engine is scanning for volatility breakouts across IWM, SPY, and QQQ.</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
